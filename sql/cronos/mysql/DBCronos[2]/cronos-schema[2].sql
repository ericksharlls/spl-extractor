...
-- -----------------------------------------------------
-- Table `db_cronos`.`tipo_funcionario`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `db_cronos`.`tipo_funcionario` (
  `id_tipo_funcionario` TINYINT NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `db_cronos`.`funcionario` (
  ...
  `ramal_funcionario` VARCHAR(3) NULL,
  `id_sigaa_funcionario` INT NULL,
  `id_tipo_funcionario` TINYINT NOT NULL DEFAULT 3,
  PRIMARY KEY (`id_funcionario`),
  INDEX `fk_funcionario_tipo_funcionario1_idx` (`id_tipo_funcionario` ASC),
  UNIQUE INDEX `id_sigaa_funcionario_UNIQUE` (`id_sigaa_funcionario` ASC),
  CONSTRAINT `fk_funcionario_tipo_funcionario1`
    FOREIGN KEY (`id_tipo_funcionario`)
    REFERENCES `db_cronos`.`tipo_funcionario` (`id_tipo_funcionario`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB
AUTO_INCREMENT = 5
...
CREATE TABLE IF NOT EXISTS `db_cronos`.`agendamento` (
  ...
  `hora_realizacao_agendamento` DATETIME NOT NULL,
  `id_usuario_sistema` SMALLINT NOT NULL,
  PRIMARY KEY (`id_agendamento`),
  INDEX `fk_agendamento_funcionario1_idx` (`id_funcionario` ASC),
  INDEX `fk_agendamento_periodo1_idx` (`id_periodo` ASC),
  INDEX `fk_agendamento_usuario1_idx` (`id_usuario_sistema` ASC),
...
CREATE TABLE IF NOT EXISTS `db_cronos`.`historico_chave` (
  ...
  INDEX `fk_historico_chave_funcionario1_idx` (`id_responsavel` ASC),
  ...
  CONSTRAINT `fk_historico_chave_usuario1`
    ...
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_historico_chave_funcionario1`
...
CREATE TABLE IF NOT EXISTS `db_cronos`.`departamento` (
  ...
  `descricao_departamento` VARCHAR(110) NOT NULL,
...
-- -----------------------------------------------------
-- Table `db_cronos`.`turma_docente`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `db_cronos`.`turma_docente` (
  `id_turma` SMALLINT NOT NULL,
  `id_docente` SMALLINT NOT NULL,
  PRIMARY KEY (`id_turma`, `id_docente`),
  INDEX `fk_turma_has_funcionario_funcionario1_idx` (`id_docente` ASC),
  INDEX `fk_turma_has_funcionario_turma1_idx` (`id_turma` ASC),
