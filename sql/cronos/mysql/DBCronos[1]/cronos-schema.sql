...
-- -----------------------------------------------------
-- Table `db_cronos`.`semestre_letivo`
-- -----------------------------------------------------
CREATE  TABLE IF NOT EXISTS `db_cronos`.`semestre_letivo` (
  `id_semestre_letivo` TINYINT NOT NULL AUTO_INCREMENT ,
  `nome_semestre_letivo` VARCHAR(30) NOT NULL ,
  `descricao_semestre_letivo` VARCHAR(50) NOT NULL ,
  `data_inicio_semestre_letivo` DATE NOT NULL ,
  `data_termino_semestre_letivo` DATE NOT NULL ,
