...
public class ServiceRegistrarOperacaoChaveComResponsavel extends ServiceRegistrarOperacaoChave {

   @Override
   protected Long obterIdResponsavel(HistoricoChave historicoChave, RegistrarOperacaoChave solicitacao) {
      System.out.println("### ServiceRegistrarOperacaoChaveComResponsavel EXECUTADO COM SUCESSO ###");
      Funcionario responsavel = this.funcionarioDao.get(solicitacao.getIdentificadorResponsavel());
      historicoChave.setIdResponsavel(responsavel.getId());
   ...
   public void valida(RegistrarOperacaoChave solicitacao) throws NegocioException {
      ...
      if (solicitacao.getIdentificadorResponsavel() == 0 || solicitacao.getIdentificadorResponsavel() == null) {
         throw new NegocioException(ErrorCode.RESPONSAVEL_VAZIO);
      }
