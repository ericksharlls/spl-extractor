...
public class ConsultarSalasDisponiveisFormBean extends AbstractConsultarFormBean {
   ...
   private Boolean exibirMensagemDeErroHorarioInvalido;
   private String mensagemDeErroHorarioInvalido;

   public ConsultarSalasDisponiveisFormBean() {
      super();
      if (this.turma == null) {
         ...
         this.desmembrarHorarioTurma = false;
         this.exibirMensagemDeErroHorarioInvalido = false;
         this.mensagemDeErroHorarioInvalido = new String("");
      }
   }
   ...
   public ExtendedTableDataModel<DadosConsultarSalasDisponiveis> getDadosDataModel() throws NegocioException {
      ...
      solicitacao.setDesmembrarHorarioTurma(this.desmembrarHorarioTurma);
      ...
      this.dataModel = new ExtendedTableDataModel<DadosConsultarSalasDisponiveis>(new DataProvider<DadosConsultarSalasDisponiveis>() {
         ...
         public Object getKey(DadosConsultarSalasDisponiveis item) {
            return item.getNome() + item.getHorario();
         }
   ...
   public String alocar() throws NegocioException {
      ...
      for (DadosConsultarSalasDisponiveis d : getSalasSeleciondas()) {
         this.idSala = d.getId();
         this.horarioAlocacao = d.getHorario();
      }
      solicitacao.setIdTurma(this.idTurma);
      solicitacao.setIdSala(this.idSala);
      solicitacao.setHorario(this.horarioAlocacao);
      solicitacao.setHorarioDesmembrado(this.desmembrarHorarioTurma);
   ...
   public String atualizarTurma() throws NegocioException {
      ...
      if (!auxiliar.validarHorarioComSabado(this.getTurma().getHorario())) {
         this.mensagemDeErroHorarioInvalido = "TURMA N\u00C3O PODE SER ALOCADA: HOR\u00C1RIO INV\u00C1LIDO";
         this.exibirMensagemDeErroHorarioInvalido = true;
      } else {
         this.exibirMensagemDeErroHorarioInvalido = false;
      }
      return null;
   ...
   public void setHorarioAlocacao(String horarioAlocacao) {
      this.horarioAlocacao = horarioAlocacao;
   }

   public Boolean getExibirMensagemDeErroHorarioInvalido() {
      return exibirMensagemDeErroHorarioInvalido;
   }

   public void setExibirMensagemDeErroHorarioInvalido(Boolean exibirMensagemDeErroHorarioInvalido) {
      this.exibirMensagemDeErroHorarioInvalido = exibirMensagemDeErroHorarioInvalido;
   }

   public String getMensagemDeErroHorarioInvalido() {
      return mensagemDeErroHorarioInvalido;
   }

   public void setMensagemDeErroHorarioInvalido(String mensagemDeErroHorarioInvalido) {
      this.mensagemDeErroHorarioInvalido = mensagemDeErroHorarioInvalido;
   }
