...
public class ListarDepartamentoFormBeanAntigo extends AbstractFormBean {
		
		private static final long serialVersionUID = 1L;
		
		public ListarDepartamentoFormBeanAntigo() {
			super();
		}
		...
		public List<SelectItem> getDados() throws NegocioException {
			...
			if (!dados.isEmpty()) {
				...
				for (DadosListarDepartamento d : dados) {
					itens.add(new SelectItem(d.getNome(), d.getNome()));
				}
			}
			return itens;
		}
