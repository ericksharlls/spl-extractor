...
public class DadosObterFeriado implements Serializable {
   ...
   /**
    * Recupera o valor do atributo nomePeriodo
    * @return o nomePeriodo
    */
   ...
   /**
    * Atribui o novo valor de nomePeriodo
    * @param nomePeriodo nomePeriodo que será atribuído
    */
